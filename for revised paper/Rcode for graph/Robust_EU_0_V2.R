data1<- read.csv("/Users/yicheng/Dropbox/COVID-19-Mask/RED/Second_Review/data/All_graphs/data/230504 EndoU alpha1, graph.csv",head=T)
data2<- read.csv("/Users/yicheng/Dropbox/COVID-19-Mask/RED/Second_Review/data/All_graphs/data/230504 EndoU I03, graph.csv",head=T)
data3<- read.csv("/Users/yicheng/Dropbox/COVID-19-Mask/RED/Second_Review/data/All_graphs/data/230504 EndoU extreme, graph.csv",head=T)
data4<- read.csv("/Users/yicheng/Dropbox/COVID-19-Mask/RED/Second_Review/data/All_graphs/data/230504 EndoU gamma09, graph.csv",head=T)
...
xlab="Coverage rate of new masks to the population at t=1", ylab="Gains from early participation in the GRBT (A, D: ten times the original scale; B, C: original scale)",type="l",ylim=c(1.75*min(ndata22$ic),1.75*max(ndata22$ic)),xlim=c(0.08,0.82),
par.settings = theEconomist.theme(box = "transparent",with.bg =T),
lattice.options = theEconomist.opts())

m<- 3.75
pdf("/Users/yicheng/Dropbox/COVID-19-Mask/RED/Second_Review/data/All_graphs/graph/Robust_EU_0.pdf",width =1.618*1.8*m, height = 3*m) 
