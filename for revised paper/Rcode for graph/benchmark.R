data<- read.csv("/Users/yicheng/Dropbox/COVID-19-Mask/RED/Second_Review/data/All_graphs/data/benchmark.csv",head=T)
attach(data)
...
m<- 3.75
pdf("/Users/yicheng/Dropbox/COVID-19-Mask/RED/Second_Review/data/All_graphs/graph/benchmark.pdf",width =1.618*1.8*m, height = 1*m) 
